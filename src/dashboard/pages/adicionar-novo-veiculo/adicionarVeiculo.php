...
$pasta = $_SERVER['DOCUMENT_ROOT']."/sistemadecarro/src/assets/img/imagens_veiculos/";
...
try {
   ...
   $_SESSION['msgError'] = "Erro ao adicionar veiculo";
    header('location: http://localhost/sistemadecarro/src/dashboard/pages/adicionar-novo-veiculo/'); 
    exit;
 }
    ...
    header('location: http://localhost/sistemadecarro/src/dashboard/pages/estoque/');
